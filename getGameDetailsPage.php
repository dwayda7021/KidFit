 <?php
/*
getGameDetailsPage.php
 INPUT --- EMAIL, ACCESS TOKEN AND GAMEINSTANCE ID
OUTPUT -- groupName, NUMBEROFPLAYERS , OWNER OF GAME,GAMESTATUS AND USERNAME USERID AND GAMESTATUS OF EACH PLAYER & SELF STATUS
*/
...
while($playersrow = $playersData->fetch_assoc())
{
	...
	if($userGameStatus!='userQuit')
	{
		...
		{
			$json_arr['selfGameStatus']= $userGameStatus;
		}
	}	
