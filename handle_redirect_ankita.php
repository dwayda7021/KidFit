...
else
{
	...
	if($user_SQL=="null")
		...
		$reg = true;
		echo $return_code,"<br/>";
		$data = array ('clientId' => '22CNVR', 'grant_type' => 'authorization_code', 'redirect_uri' => 'http://kidsteam.boisestate.edu/kidfit/handle_redirect.php', 'code' => $return_code,'expires_in' => 604800);
