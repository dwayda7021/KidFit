...
else
{
	...
	if($user_SQL=="null")
		...
		$reg = true;
		echo $return_code,"<br/>";
		$data = array ('clientId' => $client, 'grant_type' => 'authorization_code', 'redirect_uri' => 'http//kidsteam.boisestate.edu/kidfit/handle_redirect.php', 'code' => $return_code,'expires_in' => 604800);
	...
	$data_user_heart = $data_user_summary['heartRateZones'];
